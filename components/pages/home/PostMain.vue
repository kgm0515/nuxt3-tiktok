<template>
  <div id="PostMain" class="flex border-b py-6">
    <div class="cursor-pointer">
      <img class="rounded-full max-h-[60px]" width="35" src="https://picsum.photos/id/8/300/320" />
    </div>
    <div class="pl-3 w-full px-4">
      <div class="flex items-center justify-between pb-0.5">
        <button>
          <span class="font-bold hover:underline cursor-pointer break-all">User name</span>
          <span class="text-[13px] text-light text-gray-500 pl-1 cursor-pointer">User name</span>
        </button>
        <button class="border text-[15px] px-[21px] py-0.5 border-[#f02c56] text-[#f02c56] hover:bg-[#ffeef2] font-semibold rounded-md">Follow</button>
      </div>
      ...
      <div class="mt-2.5 flex">
        <div class="relative min-h-[480px] max-h-[580px] max-w-[260px] flex items-center bg-black rounded-xl cursor-pointer">
          <video ref="video" loop muted class="rounded-xl object-cover mx-auto h-full" src="/warrior.mp4"></video>
